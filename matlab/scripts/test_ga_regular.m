...
outputFile = 'ga_regular_20141117.csv';
...
%Linux:
path_wildchar = '/home/andres/Documents/hga_vrpsd/instances/medium/*.dat';
path = '/home/andres/Documents/hga_vrpsd/instances/medium/';
...
for i=1:length(listing)
    ...
    fprintf(oFile,'\r\n');
    % ---
    hgexport(fig,['/home/andres/Documents/hga_vrpsd/outcomes/ga/regular/' listing(i).name '.eps']);
    close(fig);
end
% -- Close outputFile
fclose(oFile);
